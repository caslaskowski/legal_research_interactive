#!/usr/bin/env python3
"""Build data/registry.json and its js/registry.js mirror from one source.

Edit the REGISTRY dict below, then run:  python3 build_registry.py
This is the only file you edit to add, move, or relabel a module.
"""
import json, os
...
REGISTRY = {
    "suite": {
        ...
        "lede": (
            "Hands-on companions to the textbook. Some drop you into a live research "
            "problem; others build a single skill the work depends on \u2014 reading a "
            "citation, navigating an annotated code, telling binding authority from "
            "persuasive. Together they map onto the book, chapter by chapter."
        ),
        "tagline": "Constantly in beta \u00b7 built by Cas Laskowski",
    },

    # ---- The Question Method, accurate to Chapter 3: five steps and a checkpoint ----
    "method": {
        "eyebrow": "The Question Method, in brief",
        "intro": (
            "The method runs through the whole book \u2014 a repeating cycle of five "
            "steps and a checkpoint. Some modules drill the entire cycle; others build "
            "a single skill the cycle depends on."
        ),
        "steps": [
        ...
        "checkpoint": {
            ...
            "d": ("Before you close out, review your work: Are your sources current, "
                  "authoritative, and from the right jurisdiction? Did your sequence of "
                  "questions capture the full scope of the issue? It is a habit you build "
                  "into every cycle and perform formally at the end."),
        },
    },

    "parts": [
        {"id": "I", "name": "Foundational Legal Research",
        ...
        {"id": "II", "name": "Advanced Legal Research",
        ...
        {"id": "III", "name": "Specialized Legal Research",
         "blurb": "Research in particular settings \u2014 legal scholarship and foreign, comparative, and international law."},
    ],

    # ---- Chapters, each with its own list of modules ----
    # status: "live" (a built module with href) | "dev" (being built) | "plan" (planned)
    "chapters": [
        # ===================== PART I =====================
        {"ch": 1, "part": "I", "slug": "foundations-of-legal-authority",
         ...
         "modules": [
            {"status": "live", "type": "orientation", "slug": "sources", "href": "modules/sources/index.html",
             "note": "Sources primer",
            ...
            {"status": "live", "type": "orientation", "slug": "rank-the-authorities", "href": "modules/rank-the-authorities/index.html",
            ...
            {"status": "live", "type": "orientation", "slug": "rank-the-authorities-quiz", "href": "modules/rank-the-authorities/quiz.html",
             "title": "Knowledge Check \u2014 Rank the Authorities",
             "desc": "Eight questions covering the hierarchy of authority, primary vs. secondary, binding vs. persuasive, statute vs. common law, and court systems \u2014 with full explanatory feedback on every choice."},
            {"status": "live", "type": "practice", "slug": "applying-the-hierarchy", "href": "modules/rank-the-authorities/practice.html",
        ...
        {"ch": 2, "part": "I", "slug": "research-platforms",
         ...
         "modules": [
            {"status": "plan", "slug": "anatomy-of-a-citation",
            ...
            {"status": "plan", "slug": "build-a-boolean-search",
             ...
             "will": ["Natural language vs. terms and connectors",
        ...
        {"ch": 3, "part": "I", "slug": "the-question-method",
         "title": "The Question Method of Legal Research",
         ...
         "modules": [
            {"status": "live", "slug": "question-method", "href": "modules/question-method/index.html",
             "note": "Draft",
            ...
            {"status": "live", "slug": "question_chain", "href": "modules/question_chain/index.html",
             "note": "Draft",
        ...
        {"ch": 4, "part": "I", "slug": "secondary-sources",
         ...
         "modules": [
            {"status": "plan", "slug": "match-the-source",
             ...
             "will": ["Match question type to source: encyclopedia, treatise, ALR, Restatement",
        ...
        {"ch": 5, "part": "I", "slug": "case-law",
         ...
         "modules": [
            {"status": "plan", "slug": "holding-vs-dictum",
        ...
        {"ch": 6, "part": "I", "slug": "statutes",
         ...
         "modules": [
            {"status": "plan", "slug": "navigate-an-annotated-code",
             ...
             "will": ["Navigate an annotated code",
            ...
            {"status": "plan", "slug": "spot-the-ambiguity",
        ...
        {"ch": 7, "part": "I", "slug": "regulations",
         ...
         "modules": [
            {"status": "plan", "slug": "statute-to-regulation",
             ...
             "will": ["The delegation chain: statute to agency to rule",
        ...
        {"ch": 8, "part": "I", "slug": "across-sources",
         ...
         "modules": [
            {"status": "plan", "slug": "map-the-triangle",
        ...
        {"ch": 9, "part": "I", "slug": "closing-out",
         ...
         "modules": [
            {"status": "plan", "slug": "tighten-then-stop",
             ...
             "will": ["Proximity connectors (/n, /s, /p) and frequency (ATLEAST)",
        ...
        {"ch": 10, "part": "II", "slug": "ethics",
         ...
         "modules": [
            {"status": "plan", "slug": "competent-research-duty",
             ...
             "will": ["Competence as a research duty (Rule 1.1)",
        ...
        {"ch": 11, "part": "II", "slug": "dockets",
         ...
         "modules": [
            {"status": "plan", "slug": "read-a-docket",
             "title": "Read a Docket",
        ...
        {"ch": 12, "part": "II", "slug": "legislative-history",
         ...
         "modules": [
            {"status": "plan", "slug": "trace-the-bill",
             ...
             "will": ["The legislative process as a research trail",
        ...
        {"ch": 13, "part": "II", "slug": "advanced-admin",
         ...
         "modules": [
            {"status": "plan", "slug": "weigh-the-agency-materials",
             ...
             "will": ["Rulemaking vs. guidance vs. adjudication",
        ...
        {"ch": 14, "part": "II", "slug": "practice-specific",
         ...
         "modules": [
            {"status": "plan", "slug": "same-cycle-different-parameters",
        ...
        {"ch": 15, "part": "II", "slug": "ai",
         ...
         "modules": [
            {"status": "plan", "slug": "verify-the-ai",
             ...
             "will": ["Where AI helps and where it hallucinates",
        ...
        {"ch": 16, "part": "II", "slug": "nextgen-bar",
         ...
         "modules": [
            {"status": "plan", "slug": "five-named-skills",
             ...
             "will": ["The five named NextGen research skills",
        ...
        # ===================== PART III =====================
        {"ch": 17, "part": "III", "slug": "scholarship",
         ...
         "modules": [
            {"status": "plan", "slug": "run-a-preemption-check",
        ...
        {"ch": 18, "part": "III", "slug": "fcil",
         ...
         "modules": [
            {"status": "plan", "slug": "foreign-comparative-international",
             ...
             "will": ["Foreign vs. comparative vs. international law",
...
with open(js_path, "w", encoding="utf-8") as f:
    f.write("/* Auto-generated from data/registry.json by build_registry.py \u2014 do not edit by hand. */\n\n")
    f.write("window.REGISTRY = " + blob + ";\n")

# quick integrity report
chs = REGISTRY["chapters"]
nmod = sum(len(c["modules"]) for c in chs)
live = sum(1 for c in chs for m in c["modules"] if m["status"] == "live")
