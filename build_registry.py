...
REGISTRY = {
    ...
    "chapters": [
        ...
        {"ch": 1, "part": "I", "slug": "foundations-of-legal-authority",
         ...
         "modules": [
            {"status": "live", "slug": "sources", "href": "modules/sources/index.html",
             "note": "Sources primer",
             "title": "How Law Is Made \u2014 A 1L Primer",
             "desc": "A guided tour of the U.S. sources of law and how they relate: primary vs. secondary, binding vs. persuasive, and the hierarchy that decides which source controls."},
            {"status": "plan", "slug": "rank-the-authorities",
             "title": "Rank the Authorities",
             "desc": "Sort a stack of authorities from a single jurisdiction by binding effect \u2014 the NextGen \u201cintra-jurisdiction source ranking\u201d skill.",
             "will": ["Order authorities by binding effect within a jurisdiction",
                      "Distinguish primary from secondary authority",
                      "Tell mandatory (binding) from persuasive authority",
                      "Spot when a statute controls over common law"]},
         ]},
