...
window.REGISTRY = {
  ...
  "chapters": [
    ...
    },
    {
      ...
      "modules": [
        ...
        {
          "slug": "ada-canvas",
          "title": "The ADA Canvas",
          "href": "ch-8/ada-canvas/index.html",
          "status": "live",
          "type": "practice",
          "verified": "July 2026",
          "desc": "The ADA's public-accommodation rules as a connected map. Pull § 12182 onto a canvas, click a defined term or cross-reference, and the definition, the DOJ regulation, or the case that answers it opens beside it — edges and all. Three starter questions guide the trail: one the Supreme Court answered (the golf cart), one still splitting the circuits (the website), and one that resolves inside the codes (the step at the door).",
          "will": [
            "Follow a defined term from a statute into its definition, the implementing regulation, and the cases construing it",
            "Watch one question produce a circuit split — and one published answer get vacated",
            "Recognize when a question resolves inside the codes and when it needs case law"
          ]
        }
      ]
    },
  ...
  "appendices": {
    ...
    "intro": "The book's how-to-read guides, as interactive anatomies, plus the glossary as a flashcard deck. Each guide lives here — reach it from this list, not from the chapter pages.",
    "items": [
      {
        "id": "A",
        "title": "How to Read a Secondary Source",
