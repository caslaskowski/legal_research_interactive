(function () {
  ...
  var TOPIC = { roles: "Role", process: "How it's made", "when-to-use": "When to use it", interactions: "How sources interact" };
  var KEYS = ["A", "B", "C", "D", "E"];
  ...
  app.appendChild(el("section", { class: "reveal" }, [
    ...
    el("p", { class: "lede" }, [Q.instructions])
  ]));
  ...
  function choose(q, chosen, optButtons, fb) {
    ...
    if (!isRight) {
      fb.appendChild(el("div", { class: "why-correct" }, [ el("b", {}, ["Why the answer is "]),
  ...
  function showEnd() {
    ...
    var msg = pct >= 90 ? "Excellent \u2014 you've got a firm grip on the sources."
      : pct >= 70 ? "Solid. Revisit the few you missed and you're there."
      : pct >= 50 ? "A reasonable start. The feedback above is where the learning is \u2014 reread it."
      : "Worth another pass. Skim the deep-dive pages, then try again.";
    endCard.innerHTML = "";
