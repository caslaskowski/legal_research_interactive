...
(function () {
  ...
  /* ---- accessible dropdown ---- */
  var openMenus = [];
  function buildDropdown(label, itemIds, activeId) {
    ...
    return el("div", { class: "menu" }, [btn, ul]);
  }
  ...
  function buildHeader(activeId) {
    ...
    var topnav = el("nav", { class: "topnav", "aria-label": "Primary" }, [
      el("a", { class: "navlink", href: "../../index.html" }, ["\u2190 All Modules"]),
      el("a", { class: "navlink", href: "index.html", "aria-current": activeId === "home" ? "page" : null }, ["Home"]),
      buildDropdown("Sources", sourcesIds, activeId),
      buildDropdown("Modules", modulesIds, activeId)
    ]);
